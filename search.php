        ...
        <div class="row">
            ...
            <div class="content-area col-md-8 content-area" id="primary">
                <main class="site-main" id="main">
                    <h1><?php _e( 'Search Results for:', 'st2' ); ?> <span><?php echo esc_html( get_search_query( false ) ); ?></span></h1>
                    ...
                    <?php if ( have_posts() ) : ?>
                        ...
                        <?php endwhile; ?>
                    <?php else : ?>
                        <p class="lead text-muted"><?php _e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'st2' ); ?></p>
                    <?php endif; ?>
                    <?php if ( !have_posts() ) : ?>
